      ...
      <Grid templateColumns={["1fr", "1fr", "2fr 1fr"]} gap={6}>
        <GridItem>
          ...
          <Text fontSize={["md", "xl", "2xl"]} marginTop="1em">
            ...
            pairs, so future programmers miss out on the invaluable experience
            of working in larger teams. Additionally, the leading motivation to
            do CS class projects are for grades, rather than for the learning
            experience.
          </Text>
          ...
          <Flex direction="column" width={"100%"} marginTop={"3em"}>
            ...
            <Box marginBottom={"3em"}>
              ...
              >
                ...
                growth and development of our club members. We provide
                team-based programming project experience and encourage
              </Text>
              <Text
                fontSize={["md", "xl", "2xl"]}
                display="inline"
